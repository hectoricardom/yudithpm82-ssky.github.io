...
import { j as je, k, a as kt, p, I, y as y$1, U } from '../../index.mjs';
...
function S() {
  return je(), ssr(v, ssrHydrationKey(), escape(createComponent(k, { get children() {
    ...
    return ssr(b, ssrHydrationKey(), escape(kt("cart.empty")), escape(createComponent(U, { href: "/", class: "btn-primary px-5 py-2.5", get children() {
