...
import { U, a as kt } from '../../index.mjs';
...
function q(r) {
  ...
  return ssr(h, ssrHydrationKey(), escape(createComponent(U, { get href() {
    return `/product/${t.id}`;
    ...
    return [createComponent(g, { get name() {
      ...
      return t.category;
    }, class: "absolute inset-0 h-full w-full transition-transform duration-300 group-hover:scale-[1.02]" }), createComponent(Show, { get when() {
      return !t.inStock;
    }, get children() {
  ...
  } })), escape(createComponent(U, { get href() {
    return `/product/${t.id}`;
...
export { B, q };
//# sourceMappingURL=PromoBanner-IjyG3wIB.mjs.map
