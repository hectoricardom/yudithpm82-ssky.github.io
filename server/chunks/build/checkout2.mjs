...
import { y, k, a as kt, I, U } from '../../index.mjs';
...
function pe() {
  ...
  return createComponent(Show, { get when() {
    ...
    return createComponent(Show, { get when() {
      ...
      return ssr(W, ssrHydrationKey(), escape(kt("cart.empty")));
    }, get children() {
      return ssr(O, ssrHydrationKey(), escape(createComponent(k, { get children() {
        return [kt("checkout.title"), " \u2014 Marquet"];
      } })), escape(kt("checkout.title")), escape(kt("checkout.customer")), escape(createComponent(s, { get label() {
        ...
        return k$1();
      }, onInput: y$1, required: true })), escape(kt("checkout.destination")), escape(createComponent(For, { each: ["USA", "CUBA"], children: (o) => ssr(X, ssrHydrationKey(), `rounded-lg py-2.5 text-sm font-semibold transition-colors ${l() === o ? "bg-white text-ink shadow-sm" : ""} ${l() !== o ? "text-muted hover:text-ink" : ""}`, o === "USA" ? escape(kt("checkout.usa")) : escape(kt("checkout.cuba"))) })), escape(createComponent(Show, { get when() {
        return l() === "CUBA";
      }, get children() {
        return [createComponent(s, { get label() {
          ...
          return B();
        }, onInput: M, required: true }), createComponent(s, { get label() {
          return kt("checkout.recipientPhone");
        }, get value() {
          return j();
        }, onInput: D, required: true })];
        ...
        return [createComponent(s, { get label() {
          ...
          return C();
        }, onInput: U$1, required: true }), createComponent(s, { get label() {
...
function s(l) {
  var _a;
  return ssr(Y, ssrHydrationKey(), `flex flex-col gap-1.5 ${escape((_a = l.class) != null ? _a : "", true)}`, escape(l.label), ssrAttribute("value", escape(l.value, true), false), ssrAttribute("required", l.required, true));
}
