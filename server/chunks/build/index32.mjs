...
import { q as q$1, k as k$1, a as kt, U as U$1 } from '../../index.mjs';
...
function E() {
  const [l, H] = createSignal(null), [v, I] = createSignal(""), [m, K] = createSignal(null), [i, { refetch: M }] = createResource(() => q$1.orders.stats()), [p, { refetch: P }] = createResource(() => ({ status: l(), search: v().trim() }), ({ status: e, search: $ }) => q$1.orders.list({ status: e != null ? e : void 0, search: $ || void 0, limit: 100 })), g = () => {
    var _a, _b;
  ...
  return ssr(R, ssrHydrationKey(), escape(createComponent(k$1, { get children() {
    ...
    return createComponent(Show, { get when() {
      ...
      return ssr(k, ssrHydrationKey(), escape(createComponent(For, { get each() {
        ...
        var _a;
        return ssr(q, ssrHydrationKey(), escape(createComponent(U$1, { get href() {
