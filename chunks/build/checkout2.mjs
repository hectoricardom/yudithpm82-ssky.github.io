...
import { y, k, a as kt, I, E } from '../../index.mjs';
...
function pe() {
  const [l, ee] = createSignal("USA"), [p, te] = createSignal(false), [g, re] = createSignal(null), [i, ne] = createSignal(null), [x, b] = createSignal(""), [f, v] = createSignal(""), [k$1, y$1] = createSignal(""), [$, w] = createSignal(""), [I$1, q] = createSignal(""), [S, A] = createSignal(""), [C, U] = createSignal(""), [_, P] = createSignal(""), [B, M] = createSignal(""), [j, D] = createSignal(""), [L, z] = createSignal(""), [E$1, F] = createSignal(""), [N, R] = createSignal(""), m = createMemo(() => y());
  return createComponent(Show, { get when() {
    return !i();
  }, get fallback() {
    return ssr(Q, ssrHydrationKey(), i().paid ? escape(kt("checkout.paySuccess")) : escape(kt("checkout.pending")), escape(i().res.orderId.slice(-8)), escape(createComponent(E, { href: "/", class: "btn-ghost px-5 py-2.5", get children() {
