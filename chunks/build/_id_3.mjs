...
import { i as it, b as I, E, a as kt } from '../../index.mjs';
...
function D() {
  const p = it(), [d, O] = createSignal(false), [c, { refetch: R }] = createResource(() => p.id, (t) => I.orders.get(t));
  return createComponent(Show, { get when() {
    ...
    var _a, _b;
    return ssr(S, ssrHydrationKey(), escape(createComponent(E, { href: "/orders", class: "inline-flex items-center gap-1 text-sm font-medium text-muted hover:text-ink", get children() {
