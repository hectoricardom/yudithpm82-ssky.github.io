...
import { j as je, l as lt, a as I, k as kt } from '../../index.mjs';
import { B as B$1, q as q$1 } from './PromoBanner-BxZ7nt9B.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
...
function et() {
  ...
  return ssr(A, ssrHydrationKey(), ssrStyleProperty("background-image:", "url(/img/hero.jpg)"), escape(kt("hero.title")), escape(kt("hero.subtitle")), escape(kt("hero.cta")), escape(createComponent(p, { get title() {
    return kt("feat.shipTitle");
  }, get desc() {
    return kt("feat.shipDesc");
  }, get icon() {
    return [ssr(F, ssrHydrationKey()), ssr(R, ssrHydrationKey()), ssr(q, ssrHydrationKey()), ssr(z, ssrHydrationKey())];
    ...
    return [ssr(H, ssrHydrationKey()), ssr(T, ssrHydrationKey())];
    ...
    return ssr(j, ssrHydrationKey(), escape(n().total), escape(kt("catalog.results")));
  } })), escape(createComponent(Show, { get when() {
    return !n.loading;
  }, get fallback() {
